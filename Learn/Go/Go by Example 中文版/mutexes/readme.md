...
func main() {
    ...
    // we’ll see later, ops will count how many operations we perform against the state. 为了比较基于互斥锁的处理方式和我们后面将要看到的其他 方式，ops 将记录我们对 state 的操作次数。
    var ops int64 = 0
...
```
显示我们对已进行了同步的 state 执行了 3,500,000 次操作。
